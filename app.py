...
# 1. Let your premium UI system initialize first (This injects the CSS background/gradients)
import ui_components as ui
ui.initialize_dashboard(
    title="Human-in-the-Loop DevOps Agent",
    subtitle="Advanced multi-agent orchestration console."
)
